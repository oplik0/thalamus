...
import type { CreateSigningKeyResponse, SigningAlgorithm } from "@/lib/types";
...
export default function CreateSigningKeyPage() {
	...
	const [createdKey, setCreatedKey] = useState<CreateSigningKeyResponse | null>(
		null,
	);
					...
					<Card className="p-6 gap-4">
						...
						<VStack className="gap-2">
							...
							<Box className="bg-background-50 p-3 rounded-lg">
								<Text size="xs" className="font-mono break-all" selectable>
		...
		<ScrollView className="flex-1 bg-background-0">
			<Box className="p-6 gap-6 max-w-2xl">
				...
				<HStack className="justify-end gap-3">
					...
					<Button onPress={handleCreate} isDisabled={createMutation.isPending}>
