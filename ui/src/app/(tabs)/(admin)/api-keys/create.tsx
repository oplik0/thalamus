...
import { CreateApiKeyResponse } from "@/lib/types";
import { useToast, Toast, ToastTitle } from "@/components/ui/toast";
import { CheckIcon, AlertTriangle, ShieldCheck } from "lucide-react-native";
      ...
      <Box className="p-6 gap-6 max-w-2xl">
        ...
        <Card className="p-6 gap-5">
          ...
          <FormControl>
            ...
            <FormControlHelper>
              <FormControlHelperText>
                Select the permissions for this API key. Leave empty for
                default scopes.
              </FormControlHelperText>
            </FormControlHelper>
            <CheckboxGroup
